...
(function () {
  ...
  function bytesToNumberLog(bytes) {
    ...
    resultStr += "无符号十进制(大端):\n" + buffer(4).getUint32(0, false) + "\n\n";
    resultStr += "无符号十进制(小端):\n" + buffer(4).getUint32(0, true) + "\n\n";

    resultStr += "无符号Big十进制(大端):\n" + buffer(8).getBigUint64(0, false) + "\n\n";
    resultStr += "无符号Big十进制(小端):\n" + buffer(8).getBigUint64(0, true) + "\n\n";

    resultStr += "十进制(大端):\n" + buffer(4).getInt32(0, false) + "\n\n";
    resultStr += "十进制(小端):\n" + buffer(4).getInt32(0, true) + "\n\n";

    resultStr += "Big十进制(大端):\n" + buffer(8).getBigInt64(0, false) + "\n\n";
    resultStr += "Big十进制(小端):\n" + buffer(8).getBigInt64(0, true) + "\n\n";

    resultStr += "浮点(大端):\n" + buffer(4).getFloat32(0, false) + "\n\n";
    resultStr += "浮点(小端):\n" + buffer(4).getFloat32(0, true) + "\n\n";
